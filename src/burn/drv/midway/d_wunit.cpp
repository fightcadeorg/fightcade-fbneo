...
static struct BurnInputInfo NbahangtInputList[] = {
	...
	{"P1 Left",				BIT_DIGITAL,	nWolfUnitJoy1 + 2,	"p1 left"},
	{"P1 Right",			BIT_DIGITAL,	nWolfUnitJoy1 + 3,	"p1 right"},
	{"P1 Turbo (B1)",		BIT_DIGITAL,	nWolfUnitJoy1 + 6,	"p1 fire 1"},
	{"P1 Shoot/Jump (B2)",	BIT_DIGITAL,	nWolfUnitJoy1 + 4,	"p1 fire 2"},
	{"P1 Pass/Steal (B3)",	BIT_DIGITAL,	nWolfUnitJoy1 + 5,	"p1 fire 3"},
	...
	{"P2 Left",				BIT_DIGITAL,	nWolfUnitJoy1 + 10,	"p2 left"},
	{"P2 Right",			BIT_DIGITAL,	nWolfUnitJoy1 + 11,	"p2 right"},
	{"P2 Turbo (B1)",		BIT_DIGITAL,	nWolfUnitJoy1 + 14,	"p2 fire 1"},
	{"P2 Shoot/Jump (B2)",	BIT_DIGITAL,	nWolfUnitJoy1 + 12,	"p2 fire 2"},
	{"P2 Pass/Steal (B3)",	BIT_DIGITAL,	nWolfUnitJoy1 + 13,	"p2 fire 3"},
	...
	{"P3 Left",				BIT_DIGITAL,	nWolfUnitJoy2 + 2,	"p3 left"},
	{"P3 Right",			BIT_DIGITAL,	nWolfUnitJoy2 + 3,	"p3 right"},
	{"P3 Turbo (B1)",		BIT_DIGITAL,	nWolfUnitJoy2 + 6,	"p3 fire 1"},
	{"P3 Shoot/Jump (B2)",	BIT_DIGITAL,	nWolfUnitJoy2 + 4,	"p3 fire 2"},
	{"P3 Pass/Steal (B3)",	BIT_DIGITAL,	nWolfUnitJoy2 + 5,	"p3 fire 3"},
	...
	{"P4 Left",				BIT_DIGITAL,	nWolfUnitJoy2 + 10,	"p4 left"},
	{"P4 Right",			BIT_DIGITAL,	nWolfUnitJoy2 + 11,	"p4 right"},
	{"P4 Turbo (B1)",		BIT_DIGITAL,	nWolfUnitJoy2 + 14,	"p4 fire 1"},
	{"P4 Shoot/Jump (B2)",	BIT_DIGITAL,	nWolfUnitJoy2 + 12,	"p4 fire 2"},
	{"P4 Pass/Steal (B3)",	BIT_DIGITAL,	nWolfUnitJoy2 + 13,	"p4 fire 3"},
...
static struct BurnInputInfo WwfmaniaInputList[] = {
	...
	{"P1 Left",				BIT_DIGITAL,	nWolfUnitJoy1 + 2,	"p1 left"},
	{"P1 Right",			BIT_DIGITAL,	nWolfUnitJoy1 + 3,	"p1 right"},
	{"P1 Punch (B1)",		BIT_DIGITAL,	nWolfUnitJoy1 + 4,	"p1 fire 1"},
	{"P1 Defense (B2)",		BIT_DIGITAL,	nWolfUnitJoy1 + 5,	"p1 fire 2"},
	{"P1 Power Punch (B3)",	BIT_DIGITAL,	nWolfUnitJoy1 + 6,	"p1 fire 3"},
	{"P1 Kick (B4)",		BIT_DIGITAL,	nWolfUnitJoy2 + 0,	"p1 fire 4"},
	{"P1 Power Kick (B5)",	BIT_DIGITAL,	nWolfUnitJoy2 + 1,	"p1 fire 5"},
	...
	{"P2 Left",				BIT_DIGITAL,	nWolfUnitJoy1 + 10,	"p2 left"},
	{"P2 Right",			BIT_DIGITAL,	nWolfUnitJoy1 + 11,	"p2 right"},
	{"P2 Punch (B1)",		BIT_DIGITAL,	nWolfUnitJoy1 + 12,	"p2 fire 1"},
	{"P2 Defense (B2)",		BIT_DIGITAL,	nWolfUnitJoy1 + 13,	"p2 fire 2"},
	{"P2 Power Punch (B3)",	BIT_DIGITAL,	nWolfUnitJoy1 + 14,	"p2 fire 3"},
	{"P2 Kick (B4)",		BIT_DIGITAL,	nWolfUnitJoy2 + 4,	"p2 fire 4"},
	{"P2 Power Kick (B5)",	BIT_DIGITAL,	nWolfUnitJoy2 + 5,	"p2 fire 5"},
...
struct BurnDriver BurnDrvUmk3uc = {
	...
	"Ultimate Mortal Kombat 3 Cup Edition (Hack, Ver. 2020-12-01)\0", NULL, "hack", "MIDWAY Wolf-Unit",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_HACK, 2, HARDWARE_MIDWAY_WUNIT, GBF_MISC, 0,
...
struct BurnDriver BurnDrvRmpgwt = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING, 3, HARDWARE_MIDWAY_WUNIT, GBF_MISC, 0,
...
struct BurnDriver BurnDrvRmpgwt11 = {
	...
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 3, HARDWARE_MIDWAY_WUNIT, GBF_MISC, 0,
