// FinalBurn Neo "Tao Taido" driver module
...
static struct BurnInputInfo TaotaidoaInputList[] = {
	...
	{"P2 Weak Kick",	BIT_DIGITAL,	DrvJoy5 + 4,	"p2 fire 4"	},
	{"P2 Medium Kick",	BIT_DIGITAL,	DrvJoy5 + 5,	"p2 fire 5"	},
	{"P2 Strong Kick",	BIT_DIGITAL,	DrvJoy5 + 6,	"p2 fire 6"	},
...
static struct BurnDIPInfo TaotaidoDIPList[]=
{
	...
	{0x03, 0xff, 0xff, 0x08, NULL					},

	{0   , 0xfe, 0   ,    2, "Coin Slot"	},
	{0x00, 0x01, 0x01, 0x01, "Same"				},
	{0x00, 0x01, 0x01, 0x00, "Individual"	},

	// Coinage condition: Coin Slot Individual
	{0   , 0xfe, 0   ,    8, "Coinage"				},
	{0x00, 0x02, 0x0e, 0x0a, "3 Coins 1 Credit"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x0c, "2 Coins 1 Credit"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x0e, "1 Coin 1 Credit"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x08, "1 Coin 2 Credits"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x06, "1 Coin 3 Credits"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x04, "1 Coin 4 Credits"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x02, "1 Coin 5 Credits"			},
	{0x00, 0x00, 0x01, 0x00, NULL},
	{0x00, 0x02, 0x0e, 0x00, "1 Coin 6 Credits"			},
	{0x00, 0x00, 0x01, 0x00, NULL},

	// Coin 1 condition: Coin Slot Same
	{0   , 0xfe, 0   ,    8, "Coin 1"				},
	{0x00, 0x02, 0x0e, 0x0a, "3 Coins 1 Credit"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x0e, 0x0c, "2 Coins 1 Credit"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x0e, 0x0e, "1 Coin 1 Credit"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	...
	{0   , 0xfe, 0   ,    8, "Coin 2"				},
	{0x00, 0x02, 0x70, 0x50, "3 Coins 1 Credit"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x60, "2 Coins 1 Credit"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x70, "1 Coin 1 Credit"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x40, "1 Coin 2 Credits"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x30, "1 Coin 3 Credits"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x20, "1 Coin 4 Credits"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x10, "1 Coin 5 Credits"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
	{0x00, 0x02, 0x70, 0x00, "1 Coin 6 Credits"			},
	{0x00, 0x00, 0x01, 0x01, NULL},
...
//	{0x01, 0x01, 0x01, 0x00, "On"					},
	...
	{0x01, 0x01, 0x18, 0x10, "Easy"					},
	{0x01, 0x01, 0x18, 0x18, "Normal"				},
	{0x01, 0x01, 0x18, 0x08, "Hard"					},
	{0x01, 0x01, 0x18, 0x00, "Hardest"			},
	...
	{0   , 0xfe, 0   ,    5, "Country"			},
	{0x03, 0x01, 0x0f, 0x00, "US"					  },
	{0x03, 0x01, 0x0f, 0x01, "Japan"				},
	{0x03, 0x01, 0x0f, 0x02, "Hong-Kong/Taiwan"	},
	{0x03, 0x01, 0x0f, 0x04, "Korea"				},
	{0x03, 0x01, 0x0f, 0x08, "World"				},
};
